...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            ...
            @include('admin.includes.Bread_Crumb',['title'=>'Edit publication'])
        </div>
        <!-- End Breadcrumb-->
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr />
                        <form method="POST" class="update_insert" action="{{ route('publication.update',$publication) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-group row">
                                <label for="input-21" class="col-sm-2 col-form-label">Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control" id="input-21" value="{{$publication->name }}" placeholder="Enter Your Name" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <img src="/{{$publication->image}}" style="height: 50px; margin-bottom: 10px;" alt="user image"> <br>
