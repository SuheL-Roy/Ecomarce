...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            ...
            @include('admin.includes.Bread_Crumb',['title'=>'Create Vendor'])
        </div>
        <!-- End Breadcrumb-->
        <div class="row">
            <div class="col-lg-10">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="insert_form" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="mobile_no" class="form-control"  cols="30" rows="10"></input>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control"  cols="30" rows="10"></input>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="address" class="form-control" id="mytextarea1" cols="30" rows="10"></textarea>
