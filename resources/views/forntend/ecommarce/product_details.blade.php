                ...
                <div class="row">
                            ...
                            <div class="single-product-tab  box-shadow mb-20">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="one">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/1.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/1.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="two">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/2.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="three">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/3.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/3.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="four">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/4.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/4.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="five">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/5.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/5.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="six">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/6.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/6.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="seven">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/7.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/7.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="eight">
                                        <a class="popup"
                                            href="{{ asset('contents/websitess') }}/img/product/8.jpg">
                                            <img src="{{ asset('contents/websitess') }}/img/product/8.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-7">
                        <div class="symple-product box-shadow bg-fff p-15 mb-30">
                            ...
                            <p>it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College
                            ...
                            <div class="simple-product-icon c-fff hover-bg pb-20 mb-10 bb">
                                <ul>
                                    <li><a href="#" data-toggle="tooltip" title="Browser Wishlist"><i
                                ...
                                <div class="tab-pane active" id="description">
                                    <div class="product-description p-20 bt">
                                        ...
                                        <p>it over 2000 years old. Richard McClintock, a Latin professor at
                                            Hampden-Sydney College in Virginia, looked up one of the more</p>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="review mb-20">
                                                                <div class="review-img">
                                                                    <img class="img-thumbnail"
                                                                        src="{{ asset('contents/websitess') }}/img/comment/1.png"
                                                                        alt="" />
                                                                </div>
                        ...
                        <div class="product-wrapper bl">
                            <div class="product-img">
                                ...
                                <div class="product-icon c-fff hover-bg">
                                    <ul>
                                        <li><a href="#" data-toggle="tooltip" title="Add to cart"><i
                                                    class="fa fa-shopping-cart"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" title="Wishlist"><i
                                                    class="fa fa-heart-o"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" title="Compare"><i
                                                    class="fa fa-comments"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" title="Accumsan eli"><i
                    ...
                    <div class="featured-wrapper p-20">
                        <div class="product-wrapper single-featured">
                            ...
                            <div class="product-img floatright">
                                <a href="#">
                                    <img src="{{ asset('contents/websitess') }}/img/product/15.jpg"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                ...
                <div class="compare-area bg-fff box-shadow mb-30">
                    ...
                    <div class="compare-menu p-20">
                        ...
                        <a href="#" data-toggle="tooltip" title="Compare"
                            class="pull-right compare text-uppercase">Compare </a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="symple-product mb-20">
                            <div class="single-product-tab  box-shadow mb-20">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="one">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/1.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="two">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/2.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="three">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/3.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="four">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/4.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="five">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/5.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="six">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/6.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="seven">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/7.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/7.jpg" alt="">
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="eight">
                                        <a class="popup" href="{{ asset('contents/websites') }}/img/product/8.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/8.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="review-area">
                                                    ...
                                                    <ul>
                                                        <li class="review-1">
                                                            <div class="review mb-20">
                                                                <div class="review-img">
                                                                    <img class="img-thumbnail" src="{{ asset('contents/websites') }}/img/comment/1.png" alt="">
                                                                </div>
                                                                <div class="review-content p-15">
                                                                    <b>admin -</b>
                ...
                <div class="featured-area bg-fff box-shadow mb-30">
                    ...
                    <div class="featured-wrapper p-20">
                        <div class="product-wrapper single-featured">
                            ...
                            <div class="product-img floatright">
                                <a href="#">
                                    <img src="{{ asset('contents/websites') }}/img/product/15.jpg"
                                        alt="" />
                                </a>
                            </div>
                        </div>
