                            ...
                            <div class="single-product-tab  box-shadow mb-20">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="one">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/1.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/1.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="two">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/2.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="three">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/3.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/3.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="four">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/4.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/4.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="five">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/5.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/5.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="six">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/6.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/6.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="seven">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/7.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/7.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="eight">
                                        <a class="popup"
                                            href="{{ asset('contents/websites') }}/img/product/8.jpg">
                                            <img src="{{ asset('contents/websites') }}/img/product/8.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="review mb-20">
                                                                <div class="review-img">
                                                                    <img class="img-thumbnail"
                                                                        src="{{ asset('contents/websites') }}/img/comment/1.png"
                                                                        alt="" />
                                                                </div>
