    ...
    <div class="feautred-active right home2 left-right-angle">
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{ asset('contents/websites') }}/img/blog/1.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                ...
                <p>Welcome to WordPress. This is your first post. Edit or delete it, then start
                    writing!Aenean posuere libero eu augue condimentum rhoncus. Praesent …</p>
            </div>
        </div>
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{ asset('contents/websites') }}/img/blog/2.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{ asset('contents/websites') }}/img/blog/3.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{ asset('contents/websites') }}/img/blog/4.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{ asset('contents/websites') }}/img/blog/5.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
