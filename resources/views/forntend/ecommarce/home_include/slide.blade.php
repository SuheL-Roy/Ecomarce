        ...
        <div class="col-lg-9 ml-auto">
            <div class="slider-area mt-35">
                <div id="slider-active">
                    <img src="{{ asset('contents/websites') }}/img/slider/5.jpg" alt=""
                        title="#active1" />
                    <img src="{{ asset('contents/websites') }}/img/slider/6.jpg" alt=""
                        title="#active2" />
                </div>
